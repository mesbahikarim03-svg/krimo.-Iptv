...
# ================== دالة توليد وتحميل صور الذكاء الاصطناعي (بدون حسابات!) ==================
...
async def run_hunter_action(bot, chat_id, message_id, args):
    try:
        ...
        if collected_links:
            ...
            # --- الخطوة 1: تحميل الصورة وإرسالها كمنشور مستقل بكابشن بسيط جدا ---
            ...
            try:
                if img_path and os.path.exists(img_path):
                    ...
                    # الخطة البديلة: إذا فشل تحميل الصورة يبعث اللوجو الأصلي
            ...
            # --- الخطوة 2: إرسال جميع الروابط (مقسّمة عشرات) بقوالبك الأصلية الفخمة كرسائل عادية ---
            all_chunks = []
